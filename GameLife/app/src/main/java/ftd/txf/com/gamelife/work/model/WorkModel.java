package ftd.txf.com.gamelife.work.model;
...
public class WorkModel implements WorkContract.Model {
    ...
    private List<Work> workList1;
    private  List<Work> xtlists=new ArrayList<>();

    @Override
    public List<Work> getWorkdata(Context context){
        mworkDBUtils=new WorkDBUtils(context);
        workList1 = mworkDBUtils.queryAllWork();
        return workList1;
    }
    @Override
    public void saveWork(Work work){
        mworkDBUtils.insertWork(work);
    }
